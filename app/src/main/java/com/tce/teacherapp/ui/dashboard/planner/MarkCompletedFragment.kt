...
class MarkCompletedFragment : Fragment(), LessonPlanClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbarTitle.setText("Mark Completed")
        ...
        binding.dateContainer.setOnClickListener(View.OnClickListener {
            val dialog = Dialog(requireActivity(), android.R.style.Theme_Dialog)
            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE)
