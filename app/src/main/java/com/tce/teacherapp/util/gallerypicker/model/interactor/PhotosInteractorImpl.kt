...
class PhotosInteractorImpl(var presenter: PhotosPresenterImpl) : PhotosInteractor {
    ...
    private fun getThumbnailPath(id: Long): String? {
        ...
        val cursor = MediaStore.Images.Thumbnails.queryMiniThumbnail(presenter.photosFragment.requireContext().contentResolver, id, MediaStore.Images.Thumbnails.MINI_KIND, null)
